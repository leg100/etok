...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/etok/flexsearch.min.js');loadScript('/etok/en.search-data.min.5aa7a53c8ffb0111c33b2ebbb57d7a36212d12caee772663f3b8cfa6fcb2d1a6.js',function(){input.required=false;search();});}
