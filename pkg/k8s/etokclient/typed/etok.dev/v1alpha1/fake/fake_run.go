...
var runsResource = schema.GroupVersionResource{Group: "etok.dev", Version: "v1alpha1", Resource: "runs"}

var runsKind = schema.GroupVersionKind{Group: "etok.dev", Version: "v1alpha1", Kind: "Run"}
