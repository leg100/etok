...
var log = logf.Log.WithName("controller_plan")

// Add creates a new Plan Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to primary resource Plan
	err = c.Watch(&source.Kind{Type: &v1alpha1.Plan{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &v1alpha1.Plan{},
	})
	if err != nil {
		return err
	}

	// Watch for changes to resource Workspace and requeue the associated Plans
	err = c.Watch(&source.Kind{Type: &v1alpha1.Workspace{}}, &handler.EnqueueRequestsFromMapFunc{
		ToRequests: handler.ToRequestsFunc(func(a handler.MapObject) []reconcile.Request {
			rc := r.(*ReconcilePlan)
			cmdList := &v1alpha1.PlanList{}
...
// blank assignment to verify that ReconcilePlan implements reconcile.Reconciler
...
func (r *ReconcilePlan) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.V(1).Info("Reconciling Plan")

	return command.Reconcile(r.client, r.scheme, request, &v1alpha1.Plan{}, "plan")
}
