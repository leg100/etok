...
var outputsResource = schema.GroupVersionResource{Group: "stok.goalspike.com", Version: "v1alpha1", Resource: "outputs"}

var outputsKind = schema.GroupVersionKind{Group: "stok.goalspike.com", Version: "v1alpha1", Kind: "Output"}
...
func (c *FakeOutputs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Output, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(outputsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Output{})
