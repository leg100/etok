...
type RunSpec struct {
	// +kubebuilder:validation:Enum={"apply","console","destroy","fmt","force-unlock","get","graph","init","import","output","plan","providers","refresh","show","state","taint","untaint","validate","sh"}
